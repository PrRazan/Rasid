...
class _MainScreenState extends State<MainScreen> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> pages = [
      DashboardPage(
        onNavigateToMap: () => _onTabTapped(3),
        onNavigateToHistory: () => _onTabTapped(2),
        isToyota: _isToyota,
        onCarChanged: (val) => setState(() => _isToyota = val),
      ),
      _isToyota
          ? const CarInfoScreen(
              model: "تويوتا كامري",
      ...
      HistoryScreen(isToyota: _isToyota),
      const MapScreen(),
    ];
...
class _DashboardPageState extends State<DashboardPage> {
  @override
  Widget build(BuildContext context) {
    final bool _isToyota = widget.isToyota;
        ...
        children: [
                ...
                Row(
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: const Text("أهلًا, -username-", style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.grey)),
                    ),
                  ],
                ),
                Row(
          ...
          Container(
            ...
            child: PopupMenuButton<bool>(
              onSelected: widget.onCarChanged,
          ...
          child: Column(
            children: [
              ...
              _TimelineItem(
                ...
                showLine: false,
                showMore: true,
                onMorePressed: widget.onNavigateToHistory,
              ),
            ],
          ),
        ),
